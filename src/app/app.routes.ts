...
export const routes: Routes = [
    ...
    },
    {
        ...
        loadComponent: () => import('./pages/bestellungen/neue-bestellung/neue-bestellung.page').then((m) => m.NeueBestellungPage),
    },
    {
        path: 'bestellungen',
        loadComponent: () => import('./pages/bestellungen/bestellungen/bestellungen.page').then((m) => m.BestellungenPage),
    },
    {
